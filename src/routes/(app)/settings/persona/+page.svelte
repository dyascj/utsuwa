...
<style>
	...
	.companion-mode-section {
		...
		gap: 0.75rem;
		padding: 1.25rem;
		background: rgba(1, 178, 255, 0.05);
	...
	.bond-section {
		padding: 1rem;
		background: linear-gradient(135deg, rgba(1, 178, 255, 0.05), rgba(1, 178, 255, 0.02));
		border-radius: 1rem;
	...
	.mood-icon-lg {
		...
		width: 48px;
		height: 48px;
		background: color-mix(in srgb, var(--mood-color, #01B2FF) 15%, transparent);
		border-radius: 50%;
